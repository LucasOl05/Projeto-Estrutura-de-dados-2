...
3-) sim possui uma relação entre número de trocas e eficiência de ordenação por causa do custo de escrita na memoria, pois, realizar uma comparação é uma operação rápida de leitura de cpu já uma troca ela envolve múltiplas operações escritas na memória então em resumo as trocas custam mais que as comparações por isso o selection costuma ser mais rápido e o bubble costuma ser o mais lento por fazer várias trocas.
